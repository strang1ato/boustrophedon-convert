To convert `html` file to boustrophedon writting style, download `boustrophedon.css` and `boustrophedon.js`, then add to the beginning and to the end of `html` file these two lines, respectively:
